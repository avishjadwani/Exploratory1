...
plot(filtereddata$dt,as.numeric(as.character(filtereddata$Sub_metering_1)),xlab = " ",ylab = "Energy Sub metering",type="l")
lines(filtereddata$dt,as.numeric(as.character(filtereddata$Sub_metering_2)),type="l",col="red")
lines(filtereddata$dt, as.numeric(as.character(filtereddata$Sub_metering_3)),type='l', col="blue")
legend('topright', c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),col=c("black","red","blue"))

plot(filtereddata$dt, as.numeric(as.character(filtereddata$Voltage)),type='l', 
     ylab="Voltage",xlab="datetime" )

plot(filtereddata$dt, as.numeric(as.character(filtereddata$Global_reactive_power)),type='l', 
